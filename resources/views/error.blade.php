...
<body class="bg-one">
        ...
        <div class="row justify-content-center align-items-center vh-100">
            <div class="col-sm-6 col-12">
                <div class="text-warning">
                    ...
                    <div class="text-end">
                        <a href="#" id="kembaliBtn" class="btn btn-light rounded-5 px-4 py-3 shadow">Kembali ke dashboard</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- JavaScript untuk kembali ke halaman sebelumnya -->
    <script>
        ...
        document.getElementById("kembaliBtn").addEventListener("click", function (event) {
